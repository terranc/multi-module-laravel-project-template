...
//             'middleware' => config('admin.route.middleware'),
    ...
    'upload' => [
        ...
        'imagePathFormat' => '/editor/images/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'scrawlPathFormat' => '/editor/images/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'snapscreenPathFormat' => '/editor/images/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/editor/images/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'videoPathFormat' => '/editor/videos/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'filePathFormat' => '/editor/files/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'imageManagerListPath' => '/editor/images/', /* 指定要列出图片的目录 */
        ...
        'fileManagerListPath' => '/editor/files/', /* 指定要列出文件的目录 */
