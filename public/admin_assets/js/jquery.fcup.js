...
var fcup_upload = {
    ...
    fcup_addFileInput: function () {
        ...
        if (C) {
            html += '<input type="file" id="' + jQuery.upInputId + '" class="' + C + '" onchange="jQuery.fcup_upload()" style="position:absolute;left:0px;top:0px;opacity:0;z-index:9999;width:' + W + 'px;height:' + H + 'px;">';
        } else {
            html += '<input type="file" id="' + jQuery.upInputId + '" onchange="jQuery.fcup_upload()" style="position:absolute;left:0px;top:0px;opacity:0;z-index:9999;width:' + W + 'px;height:' + H + 'px;">';
        }
    ...
    fcup_upFileInput: function () {
        ...
        obj.style.cssText = 'position:absolute;left:0px;top:0px;opacity:0;z-index:9999;width:' + W + 'px;height:' + H + 'px;';
    },
